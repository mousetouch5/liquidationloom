...
<div class="w-3/4 bg-white shadow-lg h-[90vh] flex flex-col">
    <div class="flex-1 flex flex-col">
        ...
        <div class="p-4 bg-gray-50">
            <h2 class="text-xl font-semibold text-gray-700"data-aos="fade-up"
            data-aos-duration="2000">Audit Trail</h2>
        </div>

        <!-- Tabs -->
        <div class="p-4 bg-gray-50" data-aos="fade-up"
        data-aos-duration="2000">
            <div class="flex space-x-6 border-b">
                ...
                <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">User</button>
                <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">Budget Allocation</button>
                <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">Expenses</button>
                <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300"> Actual Budget Used</button>
                <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">Transaction Type</button>
            </div>
        </div>
            ...
            data-aos-duration="2000">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-100">
                        <td class="px-4 py-2 bg-gray-100">Maria Catarina Agoncillo</td>
                        <td class="px-4 py-2 bg-gray-100">Brgy. Hall Construction</td>
                        <td class="px-4 py-2 bg-gray-100 text-green-500 ">₱200,000.00</td>
                        <td class="px-4 py-2 bg-gray-100 text-red-500">₱200,000.00</td>
                        <td class="px-4 py-2 bg-gray-100">Bank Transfer</td>
                    </tr>
                    <tr class="hover:bg-gray-100">
                        <td class="px-4 py-2">Dominidad Tiangco</td>
                        <td class="px-4 py-2">Community Outreach</td>
                        <td class="px-4 py-2 text-green-500">₱10,000.00 </td>
                        <td class="px-4 py-2 text-red-500">₱10,000.00</td>
                        <td class="px-4 py-2">Cash</td>
                    </tr>
                    <tr class="hover:bg-gray-100">
                        <td class="px-4 py-2 bg-gray-100 mt-2">Joshua Cabanatuan</td>
                        <td class="px-4 py-2 bg-gray-100 mt-2">Feeding Program</td>
                        <td class="px-4 py-2 bg-gray-100 mt-2 text-green-500">₱5,000.00</td>
                        <td class="px-4 py-2 bg-gray-100 mt-2 text-red-500">₱5,000.00</td>
                        <td class="px-4 py-2 bg-gray-100 mt-2">Cash</td>
                    </tr>
                    <tr class="hover:bg-gray-100">
                        <td class="px-4 py-2">Joshua Cabanatuan</td>
                        <td class="px-4 py-2">Brgy. Fiesta</td>
                        <td class="px-4 py-2 text-green-500">₱50,000.00 </td>
                        <td class="px-4 py-2 text-red-500">₱50,000.00</td>
                        <td class="px-4 py-2">Cheque</td>
                    </tr>
                    <tr class="hover:bg-gray-100">
                        <td class="px-4 py-2 bg-gray-100 mt-2">Maria Catarina Agoncillo</td>
                        <td class="px-4 py-2 bg-gray-100 mt-2">Drainage Construction</td>
                        <td class="px-4 py-2 bg-gray-100 mt-2 text-green-500">₱200,000.00</td>
                        <td class="px-4 py-2 bg-gray-100 mt-2 text-red-500">₱200,000.00</td>
                        <td class="px-4 py-2 bg-gray-100 mt-2">Cheque</td>
                    </tr>

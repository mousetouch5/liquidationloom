<x-app-layout>
    ...
    <div class="flex h-full min-h-screen">
        ...
        <div class="p-4 bg-gray-50">
            ...
            data-aos-duration="2000" >Transaction</h2>
        </div>
                            ...
                            <table class="w-full table-auto">
                                ...
                                <tbody>
                                    <tr class="odd:bg-gray-50">
                                        <td class="py-3 px-4">Community Outreach</td>
                                        <td class="py-3 px-4">16 Jul 10:00am</td>
                                        <td class="py-3 px-4 text-green-500">-₱2,000.00</td>
                                    </tr>
                                    <tr class="odd:bg-gray-50">
                                ...
                                <tfoot class="mt-5">
                                    <tr class="odd:bg-gray-50">
                                        <td class="py-3 px-4">
                                            <label for="eventProject" class="block text-sm font-medium text-gray-700">Event/Project</label>
                                        ...
                                        <td class="py-3 px-4">
                                            ...
                                            <input type="date" id="eventDate" class="w-full p-2 border border-gray-300 rounded-lg">
                                        </td>
                                        <td class="py-3 px-4">
                                            <label for="budgetAmount" class="block text-sm font-medium text-gray-700">Budget</label>
                                            <input type="number" id="budgetAmount" step="0.01" class="w-full p-2 border border-gray-300 rounded-lg" placeholder="₱0.00">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="3" class="py-3 px-4 text-center flex justify-center space-x-4">
                                            <!-- Verify Button -->
                                            <button class="flex items-center justify-center bg-cyan-500 text-white rounded-lg p-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-file-earmark-check" viewBox="0 0 16 16">
                                                    <path d="M7.293 4.293a1 1 0 0 1 1.414 0L12 7.586l3.293-3.293a1 1 0 0 1 1.414 1.414l-4 4a1 1 0 0 1-1.414 0L8 6.707l-2.707 2.707a1 1 0 0 1-1.414-1.414l3-3z"/>
                                                    <path d="M14 4.5V13a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h8.5a1 1 0 0 1 .707.293l2.5 2.5A1 1 0 0 1 14 4.5z"/>
                                                </svg>
            ...
            <aside class="lg:w-1/3 w-full mt-5 lg:mt-0" data-aos="fade-left"
            data-aos-duration="2000">

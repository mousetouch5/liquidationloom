    ...
    <div class="flex h-full min-h-screen">
        ...
        <div class="flex flex-col lg:flex-row lg:space-x-6">
                ...
                <section>
                    <div class="flex justify-between items-center" data-aos="fade-down" data-aos-duration="2000">
                        ...
                        <div class="flex space-x-4">
                            <button class="px-4 py-2  text-black rounded-lg "
                                style="background: rgba(205, 243, 255, 1);">Recent Events</button>
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-4" data-aos="fade-up" data-aos-duration="2000">
            ...
            <aside class="w-full lg:w-1/3 grid grid-cols-1 gap-6 mt-5" data-aos="fade-right"
                ...
                <!-- Barangay Officials -->
                <div class="bg-white shadow-lg rounded-lg p-6" data-aos="fade-right" data-aos-duration="2000">

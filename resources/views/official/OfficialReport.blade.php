            ...
            <h2 class="text-xl font-semibold text-gray-700">Reports</h2>
                ...
                <div class="p-4 bg-gray-50" >
                    <div class="flex space-x-6 border-b">
                        ...
                        <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">Survey Results</button>
                        <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">Budget</button>
                        <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">Expenses</button>
                        <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">Verification Files</button>
                        <button class="py-2 px-4 font-medium text-gray-700 hover:border-b-2 hover:border-gray-300">Archive</button>
                    </div>
                </div>
                ...
                data-aos-duration="2000">
                    <table class="table-auto w-full bg-white shadow-md rounded-md">
                        ...
                        <tbody>
                            <!-- Rows -->
                            <tr class="hover:bg-gray-100" data-aos="fade-left"
                            data-aos-duration="2000">
                                <td class="px-4 py-2">Community Outreach Survey</td>
                                <td class="px-4 py-2">July 2024</td>
                                <td class="px-4 py-2">
                                    <div class="flex space-x-2">
                                        <button class="material-icons text-gray-500 hover:text-blue-500 cursor-pointer" title="Download">download</button>
                                        <button class="material-icons text-gray-500 hover:text-green-500 cursor-pointer" title="Print">print</button>
                                        <button class="material-icons text-gray-500 hover:text-red-500 cursor-pointer" title="Delete">delete</button>
                                    </div>

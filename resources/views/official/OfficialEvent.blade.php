<x-app-layout>
    ...
    <div class="flex h-full min-h-screen">
        ...
        data-aos-duration="2000">
                        ...
                        <button onclick="window.location.href='{{ route('Official.Edit.index') }}'">
                            <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_2474_689)">
                                    <path d="M14.875 2.5009C15.1048 2.28203 15.3776 2.10842 15.6779 1.98996C15.9782 1.87151 16.3 1.81055 16.625 1.81055C16.95 1.81055 17.2718 1.87151 17.5721 1.98996C17.8724 2.10842 18.1452 2.28203 18.375 2.5009C18.6048 2.71977 18.7871 2.97961 18.9115 3.26558C19.0359 3.55154 19.0999 3.85804 19.0999 4.16757C19.0999 4.4771 19.0359 4.7836 18.9115 5.06956C18.7871 5.35553 18.6048 5.61537 18.375 5.83424L6.5625 17.0842L1.75 18.3342L3.0625 13.7509L14.875 2.5009Z" stroke="#767676" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                </g>
                                <defs>
            ...
            <aside class="lg:w-1/3 w-full mt-5 lg:mt-0" data-aos="fade-right"
            data-aos-duration="2000"
            >

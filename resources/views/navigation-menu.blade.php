            ...
            <div class="flex">
                ...
                <div class="flex items-center space-x-0">
                    ...
                    <div class="text-2xl font-semibold mt-4 text-center flex">
                        <h1 class="text-2xl font-semibold pl-20 mb-5">Welcome, boosssssss</h1>
                    </div>
